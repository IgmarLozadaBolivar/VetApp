...
namespace Persistence.Data.Migrations
{
    ...
    [Migration("20231019061255_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.MovimientoMedicamento", b =>
                {
                    ...
                    b.Property<LocalDateTime>("Fecha")
            ...
            modelBuilder.Entity("Domain.Entities.RefreshToken", b =>
                {
                    ...
                    b.Property<LocalDateTime>("Expires")
                        .HasColumnType("timestamp")
            ...
            modelBuilder.Entity("Domain.Entities.TratamientoMedico", b =>
                {
                    ...
                    b.Property<LocalDateTime>("FechaAdministracion")
                        .HasColumnType("timestamp")
            ...
            modelBuilder.Entity("Domain.Entities.Cita", b =>
                {
                    ...
                    b.HasOne("Domain.Entities.Veterinario", "Veterinarios")
                        .WithMany("Citas")
            ...
            modelBuilder.Entity("Domain.Entities.DetalleMovimiento", b =>
                {
                    ...
                    b.HasOne("Domain.Entities.MovimientoMedicamento", "MovimientoMedicamentos")
                        .WithMany("DetalleMovimientos")
            ...
            modelBuilder.Entity("Domain.Entities.Mascota", b =>
                {
                    b.HasOne("Domain.Entities.Propietario", "Propietarios")
                        .WithMany("Mascotas")
            ...
            modelBuilder.Entity("Domain.Entities.Medicamento", b =>
                {
                    b.HasOne("Domain.Entities.Laboratorio", "Laboratorios")
            ...
            modelBuilder.Entity("Domain.Entities.Raza", b =>
                {
                    b.HasOne("Domain.Entities.Especie", "Especies")
                        .WithMany("Razas")
            ...
            modelBuilder.Entity("Domain.Entities.TratamientoMedico", b =>
                {
                    b.HasOne("Domain.Entities.Cita", "Citas")
